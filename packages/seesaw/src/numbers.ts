...
export const toFpDecimals = (x: BigNumberish | Decimal, decimals: number): Decimal => decimal(x).mul(10**decimals);

export const fromFpDecimals = (x: BigNumberish | Decimal, decimals: number): Decimal => decimal(x).div(10**decimals);
